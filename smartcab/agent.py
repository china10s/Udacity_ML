...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        if self.Q.has_key(state):
            dicVal = self.Q[state]
            for keyAct in self.Q[state]:
                 if not maxQ or maxQ < dicVal[keyAct]:
                     maxQ = dicVal[keyAct]
            keyActRe = random.choice([act for act in self.valid_actions if self.Q[state][act] == maxQ])
        return (keyActRe,maxQ)
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            ...
            if rand > self.epsilon:
                actionRe,stateRe = self.get_maxQ(state)
                return actionRe
